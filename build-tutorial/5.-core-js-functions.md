...
**Add the code below to the bottom of your HTML.** These script tags load libraries that make coding your game much easier. **To all the people that work on free and open source projects, thank you!!** We are adding the [tabletop.js](https://github.com/jsoma/tabletop), [jquery](https://jquery.com/), [p5.js](https://p5js.org/), and the iDEW trivia libraries here. You don't have to worry too much about how these work just yet. They just do!
