...
**Copy the JavaScript below and paste it in the JS section of your CodePen \(or your own JS file if not using CodePen\).** Nothing new will happen just yet. That's next.
